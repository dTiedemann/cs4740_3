...
system spends involves reading in the input and building feature sets, which don't need
...
features as mitigating factors.  We use the empty string if there is no dependency.

\item[Presence or Absence of Dependency]
...
taken from the left the word and half from the right of the word; thus window size
